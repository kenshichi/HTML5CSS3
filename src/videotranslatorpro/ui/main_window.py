...
class MainWindow(QMainWindow):
    ...
    def _translate_all(self) -> None:
        ...
        rows, warning = translate_segments_to_vietnamese(self.current_segments, self.lang_map.get(self.source_lang.currentText(), "auto"), self.translation_mode.currentText())
    ...
    def _translate_selected(self) -> None:
        ...
        rows, warning = translate_segments_to_vietnamese(temp, self.lang_map.get(self.source_lang.currentText(), "auto"), self.translation_mode.currentText())
